        ...
        <>
            ...
            <div className="container-fluid pb-4 pt-4" style={{ background: 'linear-gradient(0deg, rgba(10, 10, 10, 0.77) 0%, rgba(9,9,9,1) 50%, rgba(0,0,0,0.742734593837535) 100%)' }}>
                <div className="container aboutsec mt-5 mb-5">
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-12 h-80" style={{ padding: '70px 20px 0px 30px', backgroundColor: 'rgba(145, 136, 136, 0.41)', border: '2px solid white' }}>
                ...
                <div className="container pt-5 pb-3"  style={{ borderTop:'1px solid white'}}>
                    <Cards />
                </div>
            </div>
            <Footer />
